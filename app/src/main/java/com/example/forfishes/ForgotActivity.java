...
public class ForgotActivity extends AppCompatActivity
{
    ...
    {
        productRefers.addListenerForSingleValueEvent(new ValueEventListener() {
            @Override
            public void onDataChange(@NonNull DataSnapshot dataSnapshot) {
                ...
                {
                    Toast.makeText(ForgotActivity.this, "The number is not registered with us before, please Register yourself as a new user", Toast.LENGTH_SHORT).show();
                }
            }
            @Override
