...
public class UserplacedActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_userplaced);
        shipped=(Button)findViewById(R.id.remove);
        userID=getIntent().getStringExtra("uid");
        orderRef1= FirebaseDatabase.getInstance().getReference().child("Admin View");
            ...
            protected void onBindViewHolder(@NonNull final CartViewHolder holder, final int position, @NonNull cart model)
            {
                ...
                shipped.setOnClickListener(new View.OnClickListener() {
                    ...
                    public void onClick(View v)
                    {
                        ...
                        AlertDialog.Builder builder= new AlertDialog.Builder(UserplacedActivity.this);
                        ...
                        builder.setItems(options, new DialogInterface.OnClickListener() {
                            ...
                            public void onClick(DialogInterface dialog, int i)
                            {
                                if(i==0)
                                {
                                    ...
                                    Toast.makeText(UserplacedActivity.this, "Done", Toast.LENGTH_SHORT).show();
                                }
    ...
    private void Removeorder(String uuu)
    {
        orderRef1.child(uuu).removeValue();
    }
